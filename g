...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <script type="text/javascript ">function googleTranslateElementInit( ) {
      new google.translate.TranslateElement({page Language: 'en'},'goggle_translate_element');
      }
      </script>
      <script type="text/javascript" scr="https://translate.google.com/translate_a/element.js? cb=googleTranslateElementInit">
      </script>

<div id="translator_6392"><noscript>Javascript is disable - <a href="http://www.webestools.com/">http://www.webestools.com/</a> - <a href="http://www.webestools.com/translator-buttons-web-page-translation-google-translate-website-widget-online-html-translator.html">Translation Buttons Generator</a></noscript></div><script type="text/javascript" src="http://services.webestools.com/translator/6392-1-yyyyyyyyy.js"></script>
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay bg-light" id="home-section">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-md-12 mt-lg-5 text-left align-self-center text-intro">
            <div class="row">
              <div class="col-lg-6">
                <h1 class="text-black">I'm Joshua Odejide</h1>
      ...
      <img src="images/face.png" alt="Image" class="img-face" data-aos="fade" width="60%"> 
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-3">
            ...
            <p><span class="d-inline-block d-md-block">20<span class="trn">text to translate</span>3 Fake St. Mountain View,</span> San Francisco, California, USA</p>
          </div>
        ...
        <div class="row">
          ...
          <p>
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  by <a href=".com" target="_blank" >Joshua Odejide</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
        </div>
